...
const PRODUITS = [
  ...
  { id: 2, type: "annales", titre: "9 Devoirs", matiere: "Mathématiques", niveau: "première", description: "Ce pdf contient 9 devoirs pour vous , n'hesitez pas de les traiter pour connaitre votre niveau.", apercu: "apercu_devoir_maths_1_premiere.pdf", prix: 500, icon: "📘", bg: "#eef2ff" },
];
